...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className="w-full bg-[#010711] text-white border-b border-amber-400 sticky top-0 z-50 shadow-md"
      >
                ...
                <div className="absolute left-0 mt-3 w-52 bg-[#0c0d0e] border border-[#262626] rounded-xl shadow-2xl py-2 overflow-hidden">
                  ...
                  <Link
                    ...
                    className={`block px-4 py-3 text-sm transition-colors duration-150 ${
                      isPathActive('/our-programs')
                        ? 'bg-[#1a1811] text-amber-400 font-semibold'
                        : 'text-white hover:bg-[#1a1811] hover:text-amber-400'
                    }`}
                  >
                    {t('our_programs')}
                  </Link>
              ...
              {openDropdown === 'business' && (
                <div className="absolute left-0 mt-3 w-52 bg-[#0c0d0e] border border-[#262626] rounded-xl shadow-2xl py-2 overflow-hidden">
                  ...
                  <Link
                    ...
                    className={`block px-4 py-3 text-sm transition-colors duration-150 ${
                      isPathActive('/business-partners')
                        ? 'bg-[#1a1811] text-amber-400 font-semibold'
                        : 'text-white hover:bg-[#1a1811] hover:text-amber-400'
                    }`}
                  >
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-[#050b14] border-b border-amber-400 px-6 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
            ...
            <div>
              <button
                onClick={() =>
                  toggleDropdown('m_programs')
                }
                className={`w-full flex justify-between items-center py-1 font-semibold ${
                  isDropdownActive([
                    '/our-programs',
                    '/how-it-works'
                  ])
