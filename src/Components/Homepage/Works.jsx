...
const Works = () => {
  ...
  const steps = [
    {
      id: "01",
      title: t("explore_programs"),
      description: t("explore_programs_desc"),
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      id: "02",
      title: t("choose_your_program"),
      description: t("choose_program_desc"),
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      id: "03",
      title: t("complete_the_process"),
      description: t("complete_process_desc"),
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description: t("start_journey_desc"),
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
            {t("getting_started")}{" "}
            <span className="text-amber-500">{t("simple")}</span>
          </h2>
